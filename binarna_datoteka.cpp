...
int main(){
    ...
    int brUcenika = 0;
    fstream datoteka1("C:/Users/Ga-gama/Documents/GitHub/test_luka/data.bin", ios::binary | ios::in);
    ...
    fstream datoteka2("C:/Users/Ga-gama/Documents/GitHub/test_luka/data.bin", ios::binary | ios::out | ios::trunc);
